...
def move_forward(meters):
    while meters > 0:
        send_local_ned_velocity(droneSpeed, 0, 0, 0)
        time.sleep(1)
        meters = meters-1
...
def move_left(meters):
    while meters > 0:
        send_local_ned_velocity(0, -droneSpeed, 0, 0)
        time.sleep(1)
        meters = meters-1
...
def move_up(meters):
    while meters > 0:
        send_local_ned_velocity(0, 0, -droneSpeed, 0)
        time.sleep(1)
        meters = meters-1
...
vehicle.simple_takeoff(height + 3)
